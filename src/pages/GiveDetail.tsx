...
import { useColorModeValue, Flex, Text, Image, Stack, Button, Center, IconButton, Divider } from "@chakra-ui/react";
        ...
        <Center>
            {!data?.giveById ? (
                ...
                <Flex
                    ...
                    bg={bg}
                >
                    <Image boxSize="400px" src="https://aumento.officemate.co.th/media/catalog/product/O/F/OFM5232010.jpg?imwidth=640" />
                    <Flex direction="column" p={3}>
                        ...
                        <Stack isInline mt={3}>
                            ...
                            <Text color={data.giveById.inventory === 0 ? "red" : undefined}>{data.giveById.inventory}</Text>
                        </Stack>
                        <Divider orientation="horizontal" />
                        ...
                        <Flex mt={3}>
                            <Text w="130px" fontWeight="semibold">Details : </Text>
                        </Flex>
                        <Flex ml={4}>
                        ...
                        {data.giveById.inventory === 0 ? (
                            <Text mt={3} fontWeight="semibold" color="red" fontSize="2xl">Out of stock</Text>
                        ) : (
                            <Center>
                                <Flex mt={3}>
                                    <Flex h="40px" bg="blackAlpha.100" rounded="20px">
                                        <IconButton
                                            aria-label=""
                                            icon={<MinusIcon />}
                                        ...
                                        <Center>
                                            <Flex ml={3} mr={3} mt="-1">
                                                <Text fontWeight="semibold" fontSize="2xl">{quantity}</Text>
                                            </Flex>
                                        </Center>
                                        <IconButton
                                            aria-label=""
                                            icon={<SmallAddIcon />}
                                            style={{ cursor: quantity === data.giveById.inventory ? 'not-allowed' : undefined }}
                                            onClick={() =>
                                                setQuantity((prev) => {
                                    ...
                                    {isOpen &&
                                        //FIXME: CreateOrder ไม่ใช่ AddAndEditGive
                                        <AddAndEditGive
                                            Open={true}
