...
import { Flex, Table, Tbody, Text, Th, Thead, Tr, useColorMode } from "@chakra-ui/react";
                ...
                <Table variant="striped" colorScheme={colorMode === "light" ? "green" : "blue"}>
                    <Thead>
                        <Tr bg={colorMode === "light" ? "#028174" : "#3E54D3"}>
                            <Th textAlign="center" fontSize="md" w="20%" color="white">วันที่สั่ง</Th>
                            <Th textAlign="center" fontSize="md" w="20%" color="white">ชื่อของที่เบิก</Th>
                            <Th textAlign="center" fontSize="md" w="15%" color="white">จำนวนร้องขอ</Th>
                            <Th textAlign="center" fontSize="md" w="15%" color="white">ราคารวม</Th>
                            <Th textAlign="center" fontSize="md" w="10%" color="white">สถานะ</Th>
                            <Th textAlign="center" fontSize="md" w="20%" color="white">ดูรายละเอียด</Th>
                        </Tr>
                    </Thead>
                    <Tbody>
