...
import { useGiveOrderByIdCdcQuery } from "../generated/graphql";
                    ...
                    >
                        <Flex w={[null, null, null, "40%"]} justify="center">
                            {data.giveOrderByIdCdc.give.imageUrl && (
                                <Image borderRadius="xl" boxSize="400px" src={data.giveOrderByIdCdc.give.imageUrl} />
                            )}
                        </Flex>
